...
class Airline extends JPanel implements ActionListener{
	...
	private void Table_init() throws SQLException{
		...
		//Insert Sample Data
		/*model.addRow(new Object[]{"","A01","Delta","USA","주소1","+1-12-3456-7890"});
		model.addRow(new Object[]{"","A02","Cathay Pacific","China","주소2","+1-12-3456-7890"});
		model.addRow(new Object[]{"","A03","Air Canada","China","주소3","+1-12-3456-7890"});
		model.addRow(new Object[]{"","A04","Korean Air","Korea","주소4","+82-10-3456-7890"});
		model.addRow(new Object[]{"","A05","Air France","France","주소5","+1-12-3456-7890"});*/
